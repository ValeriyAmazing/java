(function () {
    ...
    function getLocalArray() {
        ...
        for (i = 0; i < li.length; i++) {
            ...
            if (li[i].classList.contains("list-group-item-success")) {
                array.push({ name: li[i].childNodes[0].textContent, done: true })
            }
            else array.push({ name: li[i].childNodes[0].textContent, done: false })
        }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        createTodoApp(document.getElementById('my-todo'), 'Список дел', JSON.parse(localStorage.getItem('array')), 'array');
